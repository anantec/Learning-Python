...
# concatenation of two varriables and strings
...
# concatenation of non similar variables is not possible in python without converting then into the same data type
